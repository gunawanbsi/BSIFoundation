<section class="container"> <!-- ini bagian gambar bergeser sama teks nya -->
    ...
    <section class="sejarah"> <!--- ini bagian teks kotak kisah kami -->
        ...
        <a href="#" class="button-green">TENTANG KAMI</a>
        </div>
    </section>
    <section class="konservasi"> <!--- ini bagian dari hewan hewan konservasi nya -->
        ...
        <div class="row">
            <div class="kons-kolom">
                ...
                <div class="layer">
                    <a href="<?php echo base_url().'visitor/orangutan'?>"><h3>ORANGUTAN</h3></a>
                </div>
            </div>
            <div class="kons-kolom">
                <img src="<?php echo base_url()?>assets/img/komodo2.jpg">
                <div class="layer">
                    <a href="<?php echo base_url().'visitor/komodo'?>"><h3>KOMODO</h3></a>
                </div>
            </div>
            <div class="kons-kolom">
                <img src="<?php echo base_url()?>assets/img/bacusa.jpg">
                <div class="layer">
                    <a href="<?php echo base_url().'visitor/bacusa'?>"><h3>BADAK BERCULA SATU</h3></a>
                </div>
            </div>
            <div class="kons-kolom">
                <img src="<?php echo base_url()?>assets/img/harimau.jpg">
                <div class="layer">
                    <a href="<?php echo base_url().'visitor/harimau'?>"><h3>HARIMAU SUMATERA</h3></a>
                </div>
            </div>
            <div class="kons-kolom">
                <img src="<?php echo base_url()?>assets/img/gajah.jpg">
                <div class="layer">
                    <a href="<?php echo base_url().'visitor/gajah'?>"><h3>GAJAH SUMETERA</h3></a>
                </div>
            </div>
        </div>
    </section>