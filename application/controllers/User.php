...
class User extends CI_Controller
{
    ...
    public function prosesAdopsi(){
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show mt-x" align="center" role="alert">Selamat! Anda sudah terdaftar menjadi Adopter.</div>');
